...
<div class="content">
	...
	<form method="post">
		<?php
			...
			$result = $dbConnection->prepare("SELECT * FROM `Users` WHERE `id` = :id");
		...
		<br><br>
		<h4>New Address</h4>
		<textarea style="width: 50vw" name="new"></textarea>
		<br><br>
		<a href="./userOrder.php">

		<button style="background-color: red" onclick="return confirm('Are you sure?');" class="submitReview" type="button">CANCEL
		</button>

		</a>
		<button class="submitReview" name="Update" type="submit">UPDATE</button>
	</form>
	</div>
